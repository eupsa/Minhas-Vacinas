...
<head>
  ...
  <meta
    name="description"
    content="Confirme seu cadastro no Minhas Vacinas. Digite o código enviado para seu e-mail e ative sua conta." />
  <meta
    name="keywords"
    content="confirmação, cadastro, código, ativação, minhas vacinas" />
...
<body class="bg-dark text-white font-inter overflow-x-hidden">
      ...
      <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
          ...
          <div class="hidden md:flex items-center space-x-8">
            ...
            <a
              href="/app/src/ajuda/"
              class="text-gray-300 hover:text-primary transition-colors font-medium">Suporte</a>
            <a
              href="../cadastro/"
              class="text-gray-300 hover:text-primary transition-colors font-medium">Cadastro</a>
          </div>
        ...
        <div class="space-y-2">
          ...
          <a
            ...
            <div
              class="w-10 h-10 bg-primary/20 rounded-lg flex items-center justify-center group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
              <i
                class="fas fa-headset text-primary group-hover:text-white"></i>
            </div>
            <div>
          ...
          <a
            ...
            <div
              class="w-10 h-10 bg-primary/20 rounded-lg flex items-center justify-center group-hover:bg-primary group-hover:scale-110 transition-all duration-300">
              <i
                class="fas fa-user-plus text-primary group-hover:text-white"></i>
            </div>
            <div>
  ...
  <!-- Hero Section -->
  <section
    class="pt-20 pb-8 gradient-bg hero-pattern relative overflow-hidden">
    <!-- Floating Elements -->
    <div
      class="absolute top-10 left-10 w-8 h-8 bg-primary/20 rounded-full blur-lg animate-float-slow"></div>
    <div
      class="absolute top-20 right-20 w-12 h-12 bg-primary/10 rounded-full blur-xl animate-float-fast"></div>

    <div class="container mx-auto px-6 pt-8">
      <div class="max-w-2xl mx-auto text-center">
        <div class="animate-fade-in-up">
          <div
            class="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center mx-auto mb-4 animate-pulse-slow">
            <i class="fas fa-envelope-open-text text-white text-lg"></i>
          </div>

          <h1 class="text-2xl lg:text-3xl font-bold mb-4 leading-tight">
            Quase pronto!
            <span class="text-gradient">Confirme seu e-mail</span>
          </h1>
      ...
      <div class="max-w-lg mx-auto">
        <div class="glass-card rounded-2xl p-6 md:p-8">
          ...
          <div class="text-center mb-6">
            <div
              class="bg-primary/10 rounded-xl p-4 border border-primary/20 mb-4">
              <i class="fas fa-info-circle text-primary text-lg mb-2"></i>
              <p class="text-gray-300 text-sm leading-relaxed">
                Código de
                <span class="text-primary font-semibold">6 dígitos</span>
                enviado para seu e-mail. Verifique sua caixa de entrada.
              </p>
            </div>
          </div>
          ...
          <form
            ...
            class="space-y-6"
            method="post"
            action="../backend/confirmar-cadastro.php">
            <!-- Code Input -->
            <div class="space-y-3">
              <label
                class="block text-center text-sm font-medium text-gray-300 mb-3">
                Digite o código de confirmação
              </label>
              <div class="flex justify-center gap-2">
                <input
                  type="text"
                  class="codigo-input w-10 h-12 text-center text-xl font-bold bg-dark border border-primary/30 rounded-lg text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all duration-200"
                  maxlength="1"
                  inputmode="numeric"
                  pattern="[0-9]*" />
                <input
          ...
          <div class="mt-6 text-center">
            <div class="relative my-4">
              ...
              <div class="relative flex justify-center text-sm">
                <span class="px-3 bg-dark-card text-gray-400 text-xs">Não recebeu?</span>
              </div>
            </div>
            <button
              id="resend-btn"
              class="text-primary hover:text-primary-light font-medium transition-colors text-sm">
  ...
  <div id="resend-modal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="fixed inset-0 flex items-center justify-center p-4">
      <div class="glass-card rounded-xl p-6 max-w-sm w-full shadow-2xl">
        <div class="text-center mb-4">
          ...
          <h3 class="text-lg font-bold text-white mb-1">Reenviar Código</h3>
          <p class="text-gray-400 text-sm">Digite seu e-mail</p>
        </div>

        <form
          id="form-reenviar-email"
          class="space-y-4"
          method="post"
          action="../backend/reenviar-email.php">
          <div>
            <label
              for="email-resend"
              class="block text-xs font-medium text-gray-300 mb-1">E-mail</label>
            <input
              type="email"
              id="email-resend"
              name="email"
          ...
          <div class="flex space-x-3">
            <button
              type="button"
              id="cancel-resend"
              class="flex-1 bg-gray-600 hover:bg-gray-700 text-white px-3 py-2.5 rounded-lg font-medium text-sm transition-colors">
              Cancelar
            </button>
            <button
              type="submit"
              id="confirm-resend"
              class="flex-1 btn-primary px-3 py-2.5 rounded-lg font-medium text-sm">
              <span id="resend-text">Reenviar</span>
              <div id="resend-loading" class="hidden inline-block ml-1">
                <div
        ...
        <div id="resend-response" class="mt-3"></div>
      </div>
    </div>
  </div>
  ...
  <script>
    ...
    document.addEventListener("keydown", function(e) {
      if (e.key === "Escape") {
        ...
        if (!resendModal.classList.contains("hidden")) {
          resendModal.classList.add("hidden");
        }
      }
    });
