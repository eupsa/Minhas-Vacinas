...
<head>
    ...
    <!-- Meta Tags -->
    <meta name="description" content="Faça login na sua conta Minhas Vacinas e acesse seu painel de controle de vacinas.">
    <meta name="keywords" content="login, entrar, acesso, conta, minhas vacinas">
            ...
            <div class="container mx-auto px-6 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="hidden md:flex items-center space-x-8">
                        ...
                        <a href="" class="text-primary transition-colors font-medium">Entrar</a>
                    </div>

                    <!-- CTA Button -->
                    <div class="hidden md:block">
                        <a href="../cadastro/" class="bg-transparent border border-primary text-primary hover:bg-primary hover:text-white px-6 py-2 rounded-full transition-all duration-200">
    ...
    <div class="fixed top-0 right-0 h-full w-80 max-w-sm off-canvas-menu z-50 transform translate-x-full transition-transform duration-300 ease-in-out" id="off-canvas-menu">
        <div class="flex flex-col h-full">
            ...
            <div class="p-6 border-t border-gray-600 space-y-4">
                <a href="../cadastro/" class="w-full bg-transparent border border-primary text-primary hover:bg-primary hover:text-white px-6 py-3 rounded-xl font-semibold flex items-center justify-center space-x-2 transition-all duration-200">
            ...
            <div class="max-w-2xl mx-auto text-center">
                <div class="animate-fade-in-up">
                    ...
                    <h1 class="text-2xl lg:text-3xl font-bold mb-4 leading-tight">
                        Acesse sua <span class="text-gradient">conta</span>
                    </h1>

                    <p class="text-base text-gray-300 mb-6 leading-relaxed">
                        Entre e mantenha o controle da saúde da sua família
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="glass-card rounded-2xl p-6 md:p-8">
                    ...
                    <div class="text-center mb-6">
                        <div class="text-center mb-6">
                            <a href="<?= htmlspecialchars($auth_url) ?>"
                                ...
                                </svg> <span class="text-sm">Continuar com Google</span>
                            </a>
                        </div>
                    ...
                    <div class="mt-6 text-center space-y-3">
                        <div class="relative my-4">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="px-3 bg-dark-card text-gray-400 text-xs">Ainda não tem conta?</span>
                            </div>
                        </div>
                        ...
                        <div class="pt-3">
                            <p class="text-gray-400 mb-1 text-xs">Precisa confirmar o cadastro?</p>
                            <a href="../confirmar-cadastro/" class="text-primary hover:text-blue-400 transition-colors text-xs">
