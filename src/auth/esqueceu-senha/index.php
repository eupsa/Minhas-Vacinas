...
<body class="bg-dark text-white min-h-screen">
    ...
    <script>
        ...
        // Form submission
        document.getElementById('form_recovery').addEventListener('submit', async function(e) {
            e.preventDefault();
            ...
            try {
                ...
                if (response.ok) {
                    showNotification('Link de recuperação enviado! Verifique seu e-mail.', 'success');
                    this.reset();
                } else {
                ...
                showNotification('E-mail não encontrado ou erro no servidor. Tente novamente.', 'error');
